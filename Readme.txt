...
Now, the cards become opaque, and you need to match identical cards in the pair of 2 cards each, and based on that, score and failed attempts are calculated.
Also, max. number of clicks are provided to make the game a bit tricky. The number of clicks is calculated based on identical cards.
